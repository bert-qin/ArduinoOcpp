...
public:
    ...
    virtual void loadStaticKey(Variable& var, const ComponentId& component, const char *variableName, const char* instanceName) { } //possible optimization: can replace internal key with passed static key
};
